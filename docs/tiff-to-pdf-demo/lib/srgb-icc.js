...
// Source: Apple macOS system profile, identical to the HP/ICC standard
const b64 = `
...
const _cache = new Uint8Array(
  [...atob(b64)].map(c => c.charCodeAt(0))
);

/** @returns {Uint8Array} sRGB ICC profile bytes */
export function srgbIcc() { return _cache; }
