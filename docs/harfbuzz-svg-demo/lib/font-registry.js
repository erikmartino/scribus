...
export class FontRegistry {
   ...
   * @param {string} styleKey — "regular"|"bold"|"italic"|"bolditalic"
   * @returns {{ hbFont: object, hbFace: object, upem: number }}
   */
  getFont(styleKey) {
  ...
  /**
   * Derive the style key from a { bold, italic } style object.
