...
PyMethodDef scribus_methods[] = {
	...
	{ "getRTL", (PyCFunction) scribus_getrtl, METH_NOARGS, tr(scribus_getrtl__doc__)},
	...
	{ "setExportableObject", scribus_setexportableobject, METH_VARARGS, tr(scribus_setexportableobject__doc__)},
