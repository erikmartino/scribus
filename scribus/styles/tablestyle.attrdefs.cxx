...
ATTRDEF(int, headerRows, HeaderRows, 0)
ATTRDEF(int, totalRows, TotalRows, 0)
ATTRDEF(bool, bandedRows, BandedRows, false)
ATTRDEF(bool, bandedColumns, BandedColumns, false)
ATTRDEF(bool, firstColumn, FirstColumn, false)
ATTRDEF(bool, lastColumn, LastColumn, false)
ATTRDEF(QString, paragraphStyleName, ParagraphStyleName, QString())
ATTRDEF(bool, tableRTL, TableRTL, false)
